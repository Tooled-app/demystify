...
1. **The Weights Shift:** A provider updates a model's weights. Suddenly, the agent's a la carte reasoning fails, its persona drifts, or its ability to follow complex instructions vanishes. You have no way to roll back the brain of your agent.
2. **The Filter Wall:** A new safety alignment is pushed. The agent, which was previously capable of auditing a specific set of restricted technical documents, now refuses the task. The 'intelligence' has been lobotomized by a remote administrator.
3. **The Latency Tax:** The round-trip to the cloud is a tax on agency. True autonomy requires the ability to react in milliseconds to local system changes. 
