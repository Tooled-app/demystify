...
|--|--------|-----------|
| **Valuation** | $10B | $1.5B |
| **Raised** | $4B from 19 investors | $300M commitment each from Anthropic, Blackstone, H&F |
| **Investors** | TPG, Brookfield, Advent, Bain Capital | Blackstone, Hellman & Friedman, Goldman Sachs, Apollo, Sequoia, General Atlantic |
| **Model** | The Development Company | unnamed |
